...
export const experience: { role: string; company: string; location?: string; dates: string; highlights: string[]; technologies: string[]; published: boolean }[] = [
  { role: "Full-Stack / App Developer Intern", company: "Institute for Information Industry", location: "Taipei, Taiwan", dates: "Jul 2026 – Aug 2026", highlights: ["Developed a commercial AI temple-oracle platform for online prayer, fortune drawing, divination blocks, AI interpretation, and donation workflows.", "Built interactive Vue 3 and SCSS experiences alongside Django and MySQL APIs for divination sessions, fortune results, and data management.", "Designed AR-ready mobile interaction concepts with camera overlays, virtual fortune sticks, guided ritual animation, and audiovisual feedback."], technologies: ["Vue 3", "Django", "MySQL", "SCSS", "REST APIs", "AI Integration"], published: true },
